...
# Constants
OWNER_IDS = [7836088695]  # Replace with the actual owner user IDs
...
async def start(client: Client, msg: Message):
    ...
    if msg.from_user.id in authorized_users:
        ...
        await start_message.edit_text(
            Data.START.format(msg.from_user.mention) + (
    "🔹 **Free Version Notice** 🆓\n\n"
    "Hello, {user}! I'm here to simplify your workflow. 🚀\n\n"
    "📥 **What I Do?**\n"
    "• Download videos from your **.txt** file 📄\n"
    "• Upload them directly to **Telegram** ⚡\n\n"
    "🎯 **How to Get Started?**\n"
    "• Press **/id** to begin.\n"
    "• Follow the on-screen instructions.\n\n"
    "🔓 **Unlock Full Access!**\n"
    "• Get a subscription to enjoy premium features.\n"
    "• **Contact:** @SEM2JOB for more details. 🎫\n\n"
    "🚀 Upgrade now and experience the full potential of your bot!"
)
...
Feel free to contact @SEM2JOB for further assistance or subscription details.
...
2️⃣ **/add_channel `<-100channelid>`** - ➕ Adds a channel to the allowed list.
   **Example:**

/add_channel -100973847334

OR use **/add_chat**
3️⃣ **/remove_channel `<-100channelid>`** - ➖ Removes a channel from the allowed list.
**Example:**
...
🚀 **General Commands:**
4️⃣ **/kunal** - 💡 Type this before sending your **📃 .txt** file.  
5️⃣ **/start** - 🎯 Start the bot and receive a welcome message.  
6️⃣ **/stop** - 🛑 Stop the bot.  

⏳ **Bot Running Time:**
7️⃣ **/bot_running_time** - ⏲️ Check the total running time of the bot.  

🛠️ **Txt Extractor & Editor Commands:**
8️⃣ **/youtube** - 🎥 Convert a YouTube URL to a .txt file.  
9️⃣ **/remtitle** - ✂️ Remove extra parentheses from the .txt file.  
🔟 **/h2t** - 🔄 Convert an **.html** file to a **.txt** file.  
1️⃣1️⃣ **/studyiqeditor** - 📝 Convert your StudyIQ file.  

💊 **Powerful Pill:**
1️⃣2️⃣ **/restart** - ▶️ Resume the process from where it was stopped.  

📌 **Note:** Only the bot owner or authorized users can execute these commands.  

📩 **Need Help?** Contact @SEM2JOB for assistance or subscription details.  
✨ **Enjoy & Have Fun!** ✨
"""

OWNER_TEXT = """
🔹 **Owner Commands & Controls!** 🔹

📂 **Log Channel Management:**
1️⃣ **/add_log_channel `<-100channelid>`** - 📝 Set the log channel ID.  
**Example:**

/add_log_channel -10054567890

2️⃣ **/accept_logs** - 📥 Enable backup logs (Set this to **1**).  
3️⃣ **/logs** - 🗂️ Retrieve logs from the last 2 minutes.  
4️⃣ **/watermark** - 🌊 Add a custom watermark to videos.  
5️⃣ **/name** - 🏷️ Set a custom name before file extension.  
**Example:**

/name yourname

🔒 **Authorized User Management:**
6️⃣ **/auth_users** - 👥 View the list of authorized users.  
7️⃣ **/add_auth `<userID>`** - ➕ Add a user to the authorized list.  
**Example:**

/add_auth 3495890

8️⃣ **/remove_auth `<userID>`** - ➖ Remove a user from the authorized list.  
**Example:**

/remove_auth 3957994

📌 **Allowed Channels Management:**
9️⃣ **/show_channels** - 📺 View the allowed channels list.  
🔟 **/add_channel `<-100channelid>`** - ➕ Add a channel to the list.  
**Example:**

/add_channel -100973847334

1️⃣1️⃣ **/remove_channel `<-100channelid>`** - ➖ Remove a channel from the list.  
**Example:**

/remove_channel -1003947384

🚀 **General Bot Commands:**
1️⃣2️⃣ **/sem2job** - 💡 Type before sending a **📃 .txt** file.  
1️⃣3️⃣ **/start** - 🎯 Start the bot with a welcome message.  
1️⃣4️⃣ **/stop** - 🛑 Stop the bot.  

⏳ **Bot Running Time Controls:**
1️⃣5️⃣ **/bot_running_time** - ⏲️ View total bot running time.  
1️⃣6️⃣ **/reset_bot_running_time `<hours>`** - 🔄 Reset bot running time.  
1️⃣7️⃣ **/set_max_running_time `<hours>`** - ⏳ Set max bot running time.  

🛠️ **Txt Extractor & Editor Commands:**
1️⃣8️⃣ **/youtube** - 🎥 Convert a YouTube URL to a .txt file.  
1️⃣9️⃣ **/remtitle** - ✂️ Remove extra parentheses from .txt.  
2️⃣0️⃣ **/h2t** - 🔄 Convert an **.html** file to **.txt**.  
2️⃣1️⃣ **/studyiqeditor** - 📝 Convert StudyIQ file.  

💊 **Powerful Pill:**
2️⃣2️⃣ **/restart** - ▶️ Resume the process from where it was stopped.  

📌 **Note:** Only the bot owner or authorized users can execute these commands.  

📩 **Need Assistance?** Contact @SEM2JOB for help or subscription details.  
✨ **Enjoy & Stay Productive!** ✨
"""
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send Here ♂️", url=f"https://t.me/SEM2JOB")]])
